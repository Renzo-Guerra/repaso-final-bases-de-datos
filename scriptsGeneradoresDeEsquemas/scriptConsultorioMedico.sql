DROP TABLE IF EXISTS P5P2E4_ALGORITMO;
...
DROP TABLE IF EXISTS P5P2E4_IMAGEN_MEDICA;
...
DROP TABLE IF EXISTS P5P2E4_PACIENTE;
...
DROP TABLE IF EXISTS P5P2E4_PROCESAMIENTO;
...
ALTER TABLE P5P2E4_IMAGEN_MEDICA DROP CONSTRAINT IF EXISTS FK_P5P2E4_IMAGEN_MEDICA_PACIENTE;
...
ALTER TABLE P5P2E4_IMAGEN_MEDICA DROP CONSTRAINT IF EXISTS FK_P5P2E4_PROCESAMIENTO_ALGORITMO;
...
ALTER TABLE P5P2E4_IMAGEN_MEDICA DROP CONSTRAINT IF EXISTS FK_P5P2E4_PROCESAMIENTO_IMAGEN_MEDICA;
